...
public final class WalletAio {
    ...
    public WalletAio(int i, int i2, String str, String str2, String str3, String str4, String str5, String str6, int i3, int i4, String str7, String str8, String str9, String str10, String str11, int i5, int i6, String str12, String str13, String str14, byte[] bArr) {
        this.background = i;
        this.icon = i2;
        this.title = str;
        this.subTitle = str2;
