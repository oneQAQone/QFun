...
public final class XposedHelpers {
     ...
     *   <li>{@code java.lang.String[]} (array)  (not implemented)
     *   <li>{@code android.app.ActivityThread.ResourcesKey}  (not implemented)
    ...
    /**
     * Look up and return a class if it exists. Like {@link #findClass}, but doesn't throw an exception if the class doesn't exist.
     *
    ...
    /**
     * Look up and return a field if it exists. Like {@link #findField}, but doesn't throw an exception if the field doesn't exist.
     *
     * @param clazz     The class which either declares or inherits the field.
     * @param fieldName The field name.
     ...
     * methods are not considered! That's because each method implementation exists only once in the memory, and when classes inherit it, they just get another
     * reference to the implementation. Hooking a method therefore applies to all classes inheriting the same implementation. You have to expect that the hook
     * applies to subclasses (unless they override the method), but you shouldn't have to worry about hooks applying to superclasses, hence this "limitation".
     * There could be undesired or even dangerous hooks otherwise, e.g. if you hook {@code SomeClass.equals()} and that class doesn't override the
     * {@code equals()} on some ROMs, making you hook {@code Object.equals()} instead.
     *
     * <p>There are two ways to specify the parameter types. If you already have a reference to the
     * {@link Class}, use that. For Android framework classes, you can often use something like {@code String.class}. If you don't have the class reference, you
     * can simply use the full class name as a string, e.g. {@code java.lang.String} or {@code com.example.MyClass}. It will be passed to {@link #findClass}
     * with the same class loader that is used for the target method, see its documentation for the allowed notations.
     *
     * <p>Primitive types, such as {@code int}, can be specified using {@code int.class} (recommended)
     * or {@code Integer.TYPE}. Note that {@code Integer.class} doesn't refer to {@code int} but to {@code Integer}, which is a normal class (boxed primitive).
     * Therefore it must not be used when the method expects an {@code int} parameter - it has to be used for {@code Integer} parameters though, so check the
     * method signature in detail.
     *
     * <p>As last argument to this method (after the list of target method parameters), you need
     * to specify the callback that should be executed when the method is invoked. It's usually an anonymous subclass of {@link XC_MethodHook} or
     * {@link XC_MethodReplacement}.
     *
     * <p><b>Example</b>
    ...
    /**
     * Look up and return a method if it exists. See {@link #findMethodExactIfExists(String, ClassLoader, String, Object...)} for details.
     */
    ...
    /**
     * Look up and return a method if it exists. Like {@link #findMethodExact(String, ClassLoader, String, Object...)}, but doesn't throw an exception if the
     ...
     * must be compatible with the given parameter types, i.e. the parameters must be assignable to the method's formal parameters. Inherited methods are
     * considered here.
     *
     ...
     *
     * <p>See {@link #findMethodBestMatch(Class, String, Class...)} for details. This variant
     * determines the parameter types from the classes of the given objects. For any item that is {@code null}, the type is taken from {@code parameterTypes}
     * instead.
     */
    ...
    /**
     * Look up and return a constructor if it exists. See {@link #findMethodExactIfExists(String, ClassLoader, String, Object...)} for details.
     */
    ...
    /**
     * Calls an instance or static method of the given object. The method is resolved using {@link #findMethodBestMatch(Class, String, Object...)}.
     *
    ...
    /**
     * Calls an instance or static method of the given object. See {@link #callMethod(Object, String, Class[], Object...)}.
     *
    ...
    /**
     * Calls a static method of the given class. The method is resolved using {@link #findMethodBestMatch(Class, String, Object...)}.
     *
    ...
    /**
     * Calls a static method of the given class. See {@link #callStaticMethod(Class, String, Object...)}.
     *
     * <p>This variant allows you to specify parameter types, which can help in case there are multiple
     * methods with the same name, especially if you call it with {@code null} parameters.
     */
    ...
    /**
     * Creates a new instance of the given class. The constructor is resolved using {@link #findConstructorBestMatch(Class, Object...)}.
     *
     * @param clazz The class reference.
    ...
    /**
     * Creates a new instance of the given class. See {@link #newInstance(Class, Object...)}.
     *
     * <p>This variant allows you to specify parameter types, which can help in case there are multiple
    ...
    /**
     * Attaches any value to an object instance. This simulates adding an instance field. The value can be retrieved again with
     * {@link #getAdditionalInstanceField}.
     *
     ...
     * methods, e.g. to override parameters only for the outer call. The Xposed framework uses this to load drawable replacements only once per call, even when
     * multiple {@link Resources#getDrawable} variants call each other.
     *
    ...
    /**
     * Decrements the depth counter for the given method. See {@link #incrementMethodDepth} for details.
     *
     * @param method The method name. Should be prefixed with a unique, module-specific string.
     * @return The updated depth.
     */
    ...
    /**
     * Returns the current depth counter for the given method. See {@link #incrementMethodDepth} for details.
     *
     * @param method The method name. Should be prefixed with a unique, module-specific string.
     * @return The updated depth.
     */
    ...
    /**
     * Thrown when a class loader is unable to find a class. Unlike {@link ClassNotFoundException}, callers are not forced to explicitly catch this. If
     * uncaught, the error will be passed to the next caller in the stack.
     */
