...
package me.yxp.qfun.loader.lsp100.codegen;
...
import me.yxp.qfun.loader.lsp100.Lsp100HookImpl;
import me.yxp.qfun.loader.lsp100.Lsp100HookWrapper;
import me.yxp.qfun.loader.lsp100.dyn.Lsp100CallbackProxy;
...
public class Lsp100ProxyClassMaker {
    ...
    private static String getClassNameForPriority(int priority) {
        return "me.yxp.qfun.loader.lsp100.dyn.Lsp100CallbackProxy$" + priorityToShortName(priority);
    }
