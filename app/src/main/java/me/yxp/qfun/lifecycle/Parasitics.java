...
public class Parasitics {
    ...
    private static final List<String> InjectActivityNames = Arrays
            .asList("me.yxp.qfun.activity.InjectSettings", "me.yxp.qfun.activity.JavaPlugin");
            ...
            if ("startActivity".equals(method.getName())) {
                ...
                if (index != -1) {
                    ...
                    if (component != null && HostInfo.getPackageName().equals(component.getPackageName())
                        ...
                        String proxyClassName = STUB_DEFAULT_ACTIVITY;
    ...
    private static class ProxyHandlerCallback implements Handler.Callback {
        ...
        private void onHandleLaunchActivity(Message msg) {
            try {
                ...
                if (bundle != null) {
                    bundle.setClassLoader(ClassUtils.getHostClassLoader());
    ...
    private static class PackageManagerInvocationHandler implements InvocationHandler {
